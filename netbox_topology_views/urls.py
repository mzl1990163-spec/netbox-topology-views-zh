...
urlpatterns = (
    ...
    path("savedfilters/", views.SavedFiltersView.as_view(), name="saved_filters"),
    path("images/", views.TopologyImagesView.as_view(), name="images"),
    path("images/create-group/", views.CreateIconGroupView.as_view(), name="images_create_group"),
